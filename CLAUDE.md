...
- **`index.html`** — arcade mini-games (home page, `/`): Match It, Pop Balloons, Feed Bunny, Catch Stars, **Dino Eggs**, **Dino Dig**, **Draw**, **Princess**, **Tardigrades**.
- **`learn.html`** — learning games: Find It, A is for…, **Books**, Trace It, **My Name**, Count It, Memory, Dot to Dot, Sort It, Shapes, **Count Dinos**. Dot to Dot also includes a **dinosaur** shape. Books includes **The Three Little Tardigrades** (original-words retelling of Avalynn's favourite book).
